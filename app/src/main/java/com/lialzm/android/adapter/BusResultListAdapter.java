...
import com.lialzm.android.third.location.route.BusRouteDetailActivity;
...
public class BusResultListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.title.setText(LocationUtils.getBusPathTitle(item));
        holder.des.setText(LocationUtils.getBusPathDes(item));
