...
public class CustomFlowImage extends ViewGroup implements View.OnClickListener {
    ...
    public CustomFlowImage(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//        super.addView(child);
        ...
        CustomFlowImage.LayoutParams lp =
                new CustomFlowImage.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
...
//            pics.remove(getChildCount() - 1);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            CustomFlowImage.LayoutParams lp =
                    (CustomFlowImage.LayoutParams) child.getLayoutParams();
